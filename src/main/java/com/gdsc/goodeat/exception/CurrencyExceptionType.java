...
public enum CurrencyExceptionType implements BaseExceptionType {
  ...
  CURRENCY_RATE_SCRAPING_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "Google Finance 페이지 크롤링에 실패했습니다."
  ),
  CURRENCY_RATE_ELEMENT_NOT_FOUND(
      HttpStatus.INTERNAL_SERVER_ERROR, "Google Finance 페이지에서 환율 요소를 찾을 수 없습니다."
  );
